...
const sizeOptions = ['30g', '35g', '50g', '80g', '100g', '180g', '200g']
...
const Add = () => {
  ...
  const onSubmitHandler = async (event) => {
    ...
    const normalizedSizePrices = selectedSizes.reduce((accumulator, size) => {
  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-4'>
      ...
      <button
        type='submit'
        className='w-28 py-3 mt-2 bg-black text-white rounded disabled:opacity-60'
