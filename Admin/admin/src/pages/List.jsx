...
const List = ({token}) => {
  ...
  return (
    ...
    <div className='flex flex-col gap-2'>
      ...
      <div className="hidden md:grid md:grid-cols-[80px_2fr_1.5fr_1.4fr_80px] items-center gap-4 py-3 px-4 border bg-gray-100 text-sm">
      <b>Image</b>
      <b>Name</b>
      <b>Category</b>
      <b>Size Prices</b>
      ...
      {
        list.map((item,index)=>(
          <div className='grid grid-cols-[64px_1fr_auto] md:grid-cols-[80px_2fr_1.5fr_1.4fr_80px] items-center gap-4 px-4 py-3 border' key={index}>
            ...
            <div className='hidden md:block'>
              ...
              <p className='mt-1 text-xs text-gray-500'>{getSizePriceSummary(item)}</p>
            </div>
