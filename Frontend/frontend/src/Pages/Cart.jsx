        ...
        <div className='w-full sm:w-[450px]'>
          ...
          <div className='w-full text-end'>
            <button
              ...
              className='mt-6 inline-flex items-center justify-center rounded-full bg-[#2f1d14] px-6 py-2 text-xs font-semibold uppercase tracking-[0.2em] text-white transition hover:bg-[#493024] sm:mt-8 sm:px-8 sm:py-3'
            >
              Proceed To Checkout
            </button>
          </div>
