    ...
    <section className='mx-auto mt-16 w-full max-w-xl px-4 sm:px-0'>
      <div className='mb-8'>
        ...
        <div className='mt-4 flex items-center gap-3'>
          <p className='prata-regular text-3xl text-[#2f1d14] sm:text-4xl'>{currentState}</p>
          <span className='h-px w-10 bg-[#8e634b]'></span>
        </div>
        <p className='mt-4 max-w-md text-sm leading-7 text-[#6b5648] sm:text-base'>
          Access your Brewphoria account, track orders, and keep your favorite picks close at hand.
        </p>
      </div>
      ...
      <form onSubmit={onSubmit} className='flex flex-col gap-4'>
        ...
        <button className='mt-4 inline-flex w-fit items-center justify-center rounded-full bg-[#2f1d14] px-8 py-3 text-xs font-semibold uppercase tracking-[0.2em] text-white transition hover:bg-[#493024]'>
